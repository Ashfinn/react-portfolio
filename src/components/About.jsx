...
function About() {
  return (
    <section id="about" className="mb-32 bg-black/90 text-white py-12 px-4">
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                <span className="bg-white/10 text-white px-3 py-1 rounded-lg text-sm border border-white/20 hover:bg-white hover:text-black transition-colors duration-300">
                  Python
                </span>
                <span className="bg-white/10 text-white px-3 py-1 rounded-lg text-sm border border-white/20 hover:bg-white hover:text-black transition-colors duration-300">
                  C++
